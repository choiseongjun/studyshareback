...
//
//    Page <StudyFeedList> findAllByuser_id(Pageable pageable,long user_id);
//
//    Page<StudyFeedList> findAllByDeleteynAndFeedlikeUserIdOrderByIdDesc(Pageable pageable, char c, Long id);
//
//    Optional<StudyFeedList> findByIdAndFeedlikeUserId(long id, Long id2);
//
...
//
//    Page<StudyFeedList> findDistinctAllByUserIdNotInAndDeleteynOrFeedlikeUserIdAndFeedlikeUserIdIsNullAndFeedlikeUserIdIsNotNullOrderByIdDesc(
//            Pageable pageable,List UserId, char c,  Long id);//차단하는 유저가 있는 경우
//
//    Page<StudyFeedList> findDistinctAllByDeleteynOrFeedlikeUserIdAndFeedlikeUserIdIsNullAndFeedlikeUserIdIsNotNullOrderByIdDesc(
//            Pageable pageable, char c,  Long id);//차단하는 유저가 없는 경우
//
//    Page<StudyFeedList> findAllByuser_idAndDeleteyn(Pageable pageable, long user_id, char c);
//
